...
{
	printf("Led Library Initialize...../r/n");
...
{
	int lamp = 1;
	lamp = lamp << ledNumber; // 0001000 해당하는 전구비트만 1로 바뀜
...
int ledLibRaw(char ledwannabe)//이 함수를 호출하면 ledwannabe에 맞게 8개의 로led를 전부 제어한다.
{
	if (fd > 0)
	{
		//do something
